...
//@ValidFlightNumber
@Table(indexes = {
	@Index(columnList = "scheduledArrival"), @Index(columnList = "scheduledDeparture"), @Index(columnList = "draftMode, scheduledDeparture, airline_id"), @Index(columnList = "draftMode, flight_id, scheduledDeparture")
})
