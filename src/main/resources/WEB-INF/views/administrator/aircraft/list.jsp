...
<acme:list>
	...
	<acme:list-column code="administrator.aircraft.list.label.regNumber" path="regNumber" width="25%"/>
	<acme:list-column code="administrator.aircraft.list.label.capacity" path="capacity" width="25%"/>
	<acme:list-column code="administrator.aircraft.list.label.aircraftStatus" path="aircraftStatus" width="25%"/>
</acme:list>
